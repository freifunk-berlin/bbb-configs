...
With ansible you can build a specificaly configured firmware image to flash onto your OpenWrt router. Due to properties of that image, BBB-configs can ensure proper function at certain locations, as it includes the full configuration. It also makes it easier for maintainers to remotly upgrade sites without worrying about configurations.
